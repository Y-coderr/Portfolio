  ...
  return (
    <nav className="header">
      <div className="logo">
        ...
        >
          <div className="logo-img">
            ...
            <span>&#47;</span>Y<span className="blink">&gt;</span>
          </div>
        </Link>
      </div>
      <ul
      ...
      <div className={click ? "social-links active" : "social-links"}>
        <a
          href="https://www.linkedin.com/in/yash-kadam5319"
          target="_blank"
        ...
        <a
          href="https://github.com/Y-coderr"
          target="_blank"
          rel="noopener noreferrer"
        >
          <FaGithub
        ...
        <a
          href="https://www.instagram.com/yashhuu.kdm/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <FaInstagram
